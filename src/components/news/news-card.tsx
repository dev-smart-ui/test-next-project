...
export const NewsCard:FC<TNewsCard> = ({title, text}) => {
  return (
    <article
      className="group block max-w-sm p-6 bg-[linear-gradient(45deg,#475569,transparent)] border border-slate-600 transition-colors rounded-lg shadow hover:bg-violet-400">
